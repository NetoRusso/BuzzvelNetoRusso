      ...
      <div className={Style.menuDesktop}>
        <div className={Style.navBar}>
          ...
          <div className={Style.navLinks}>
            ...
            <a href onClick={() => scrollTo("buzzvel")} target="_self" className={Style.navLink}>{t("Menu.menu3")}</a>
      ...
      <div className={Style.navMobile}>
        ...
        <div className={Style.navTab} id="navTab">
          ...
          <div className={Style.mobileNavLinks}>
            ...
            <a href onClick={() => scrollTo("buzzvel")} target="_self" className={Style.mobileNavLink}>{t("Menu.menu3")}</a>
